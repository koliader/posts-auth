...
const (
	...
	Auth_ListUsers_FullMethodName = "/Auth/ListUsers"
)
...
func (c *authClient) Register(ctx context.Context, in *RegisterReq, opts ...grpc.CallOption) (*AuthRes, error) {
	out := new(AuthRes)
...
func (c *authClient) Login(ctx context.Context, in *LoginReq, opts ...grpc.CallOption) (*AuthRes, error) {
	out := new(AuthRes)
...
func (UnimplementedAuthServer) Register(context.Context, *RegisterReq) (*AuthRes, error) {
...
func _Auth_ListUsers_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServer).ListUsers(ctx, req.(*Empty))
	}
	return interceptor(ctx, in, info, handler)
}
